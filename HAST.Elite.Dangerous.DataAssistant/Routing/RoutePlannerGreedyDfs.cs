...
// ***********************************************************************
// <copyright file="RoutePlannerGreedyDfs.cs" company="Jon Benson">
...
namespace HAST.Elite.Dangerous.DataAssistant.Routing
{
    ...
    public class RoutePlannerGreedyDfs : IRoutePlanner
    {
        ...
        /// <summary>The <see cref="RoutePlannerGreedyDfs.stopwatch" /></summary>
        ...
        /// <summary>The <see cref="RoutePlannerGreedyDfs.disposed" /></summary>
        ...
        /// <summary>Finalizes an instance of the <see cref="RoutePlannerGreedyDfs" /> class.</summary>
        ~RoutePlannerGreedyDfs()
        {
            this.Dispose(false);
        }
